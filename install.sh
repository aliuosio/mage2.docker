...
magentoComposerJson() {
    ...
    if test ! -f "$3/composer.json"; then
        ...
        message "docker exec -it -u $1 $2 composer require --dev allure-framework/allure-phpunit:1.2.3 --with-dependencies"
        docker exec -it -u $1 $2 composer require --dev allure-framework/allure-phpunit:1.2.3 --with-dependencies
    else
